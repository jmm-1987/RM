...
def resetear_y_crear_datos():
    with app.app_context():
        ...
        # Crear clientes (100 clientes distribuidos por las 8 zonas)
        clientes_data = [
            # Zona1 (12 clientes)
            {'nombre': 'Taller García', 'telefono': '600123456', 'email': 'garcia@taller.com', 'direccion': 'Calle Mayor 123', 'poblacion': 'Madrid', 'zona_id': 1, 'incluir': True},
            {'nombre': 'AutoReparaciones López', 'telefono': '600234567', 'email': 'lopez@auto.com', 'direccion': 'Plaza España 45', 'poblacion': 'Madrid', 'zona_id': 1, 'incluir': False},
            {'nombre': 'Taller Central', 'telefono': '600345678', 'email': 'central@taller.com', 'direccion': 'Gran Vía 78', 'poblacion': 'Madrid', 'zona_id': 1, 'incluir': True},
            {'nombre': 'Repuestos del Centro', 'telefono': '600456789', 'email': 'repuestos@centro.com', 'direccion': 'Calle Nueva 12', 'poblacion': 'Madrid', 'zona_id': 1, 'incluir': True},
            {'nombre': 'Taller Premium', 'telefono': '600567890', 'email': 'premium@taller.com', 'direccion': 'Calle Alcalá 234', 'poblacion': 'Madrid', 'zona_id': 1, 'incluir': False},
            {'nombre': 'AutoServicio Centro', 'telefono': '600678901', 'email': 'centro@autoservicio.com', 'direccion': 'Plaza Mayor 56', 'poblacion': 'Madrid', 'zona_id': 1, 'incluir': True},
            {'nombre': 'Taller Express', 'telefono': '600789012', 'email': 'express@taller.com', 'direccion': 'Calle Preciados 89', 'poblacion': 'Madrid', 'zona_id': 1, 'incluir': True},
            {'nombre': 'Repuestos García', 'telefono': '600890123', 'email': 'garcia@repuestos.com', 'direccion': 'Calle Montera 12', 'poblacion': 'Madrid', 'zona_id': 1, 'incluir': False},
            {'nombre': 'Taller Veloz', 'telefono': '600901234', 'email': 'veloz@taller.com', 'direccion': 'Calle Fuencarral 45', 'poblacion': 'Madrid', 'zona_id': 1, 'incluir': True},
            {'nombre': 'AutoTaller Madrid', 'telefono': '600012345', 'email': 'madrid@auto.com', 'direccion': 'Calle Hortaleza 67', 'poblacion': 'Madrid', 'zona_id': 1, 'incluir': True},
            {'nombre': 'Taller del Sol', 'telefono': '600123450', 'email': 'sol@taller.com', 'direccion': 'Calle Sol 23', 'poblacion': 'Madrid', 'zona_id': 1, 'incluir': False},
            {'nombre': 'Repuestos Central', 'telefono': '600234561', 'email': 'central@repuestos.com', 'direccion': 'Calle Arenal 34', 'poblacion': 'Madrid', 'zona_id': 1, 'incluir': True},
            
            # Zona Norte (13 clientes)
            ...
            # Polígono Industrial (12 clientes)
            ...
            # Carretera Nacional (13 clientes)
        ...
        for zona in zonas:
            clientes_zona = len([c for c in clientes_data if c['zona_id'] == zona.id])
            print(f"  {zona.nombre}: {clientes_zona} clientes")

if __name__ == '__main__':
    resetear_y_crear_datos()
