...
# Hook para inicialización automática en producción
@app.before_first_request
def initialize_database():
    """Inicializa la base de datos automáticamente en el primer request"""
    inicializar_sistema()
...
@app.before_request
def before_request():
    """Middleware simplificado - la inicialización es automática"""
    pass
